...
func (m *ShoppingCartMutation) SetUserID(s string) {
	m.user_id = &s
}

// UserID returns the value of the "user_id" field in the mutation.
func (m *ShoppingCartMutation) UserID() (r string, exists bool) {
	v := m.user_id
	if v == nil {
		return
	}
...
func (m *ShoppingCartMutation) OldUserID(ctx context.Context) (v string, err error) {
...
func (m *ShoppingCartMutation) SetItemCount(i int) {
	m.item_count = &i
	m.additem_count = nil
}

// ItemCount returns the value of the "item_count" field in the mutation.
func (m *ShoppingCartMutation) ItemCount() (r int, exists bool) {
	v := m.item_count
	if v == nil {
		return
	}
...
// OldItemCount returns the old "item_count" field's value of the ShoppingCart entity.
// If the ShoppingCart object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ShoppingCartMutation) OldItemCount(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ShoppingCartMutation) AddItemCount(i int) {
...
func (m *ShoppingCartMutation) AddedItemCount() (r int, exists bool) {
	v := m.additem_count
	if v == nil {
		return
	}
...
func (m *ShoppingCartMutation) ResetItemCount() {
	m.item_count = nil
	m.additem_count = nil
}

// SetLastUpdateTimestamp sets the "last_update_timestamp" field.
func (m *ShoppingCartMutation) SetLastUpdateTimestamp(t time.Time) {
	m.last_update_timestamp = &t
}

// LastUpdateTimestamp returns the value of the "last_update_timestamp" field in the mutation.
func (m *ShoppingCartMutation) LastUpdateTimestamp() (r time.Time, exists bool) {
	v := m.last_update_timestamp
	if v == nil {
		return
	}
	return *v, true
...
// OldLastUpdateTimestamp returns the old "last_update_timestamp" field's value of the ShoppingCart entity.
// If the ShoppingCart object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ShoppingCartMutation) OldLastUpdateTimestamp(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldLastUpdateTimestamp is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldLastUpdateTimestamp requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldLastUpdateTimestamp: %w", err)
	}
	return oldValue.LastUpdateTimestamp, nil
}

// ResetLastUpdateTimestamp resets all changes to the "last_update_timestamp" field.
func (m *ShoppingCartMutation) ResetLastUpdateTimestamp() {
	m.last_update_timestamp = nil
}
...
func (m *ShoppingCartMutation) Fields() []string {
	...
	if m.item_count != nil {
		fields = append(fields, shoppingcart.FieldItemCount)
	}
	if m.last_update_timestamp != nil {
		fields = append(fields, shoppingcart.FieldLastUpdateTimestamp)
	}
	return fields
}
...
func (m *ShoppingCartMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	...
	case shoppingcart.FieldLastUpdateTimestamp:
		return m.OldLastUpdateTimestamp(ctx)
	}
